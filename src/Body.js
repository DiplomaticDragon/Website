        ...
        <div class="row align-items-center mt-2">
            ...
            <div class="col-sm-12 col-md-12 col-xl-6 col-lg-6 dragonStory my-5">
              ...
              <h2 class="dragonStoryLine my-5">
                Generally, dragons are very fierce, but we, the NFT Dragons are peaceful, cute and want to live with humans on earth.
              </h2>

              <h2 class="dragonStoryLine my-2">
                We are going to build our community.
                Here is the first member of the <b>Diplomatic Dragon</b> community.
              </h2>
          ...
          <div class="row align-items-center mx-5">
            <h2 class="socialLine mb-4">
              Follow Dragons on social media platforms, and a lucky 100 people will get a free dragon before public launch.
            </h2>
          </div>
